...
- To clone the project on your machine: Type `git clone https://github.com/kene-creator/Retro-dashboard.git`.
...
Feel free to check the [issues page](https://github.com/kene-creator/Retro-dashboard.git/issues).
